 <div id="page-wrapper">
    ...
    ?>                      
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Tên</label>
                                <input value="<?=$row['Admin_name']?>" class="form-control" name="ten" placeholder="Tên" required=""  />
                            </div>
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input value="<?=$row['Email']?>" class="form-control" name="email" placeholder="Số điện thoại" required=""  />
                            </div>
                              <div class="form-group">
                                <label>Ảnh</label>
                                <br>
