 <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" name="benhan"><?=$row['Disease']?></textarea> 
                            </div>
                              <div class="form-group">
                                <label>Ảnh</label>
                                <br>
                    ...
                    <div class="col-lg-4" style=""><a style="font-size: 17px;" href="?controller=nhanvien&action=changepass&id=<?=$row['UserID']?>"><u>Đổi mật khẩu</u></a></div>
                </div>
                <!-- /.row -->
            </div>
            <!-- /.container-fluid -->
