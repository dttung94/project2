 <div id="page-wrapper">
    ...
    ?>                      
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Tên</label>
                                <input value="<?=$row['StaffName']?>" class="form-control" name="ten" placeholder="Tên" required=""  />
                            </div>
                    ...
                    <div class="col-lg-4" style=""><a style="font-size: 17px;" href="?controller=nhanvien&action=changepass&id=<?=$_SESSION['id']?>"><u>Đổi mật khẩu</u></a></div>
                </div>
                <!-- /.row -->
            </div>
            <!-- /.container-fluid -->
