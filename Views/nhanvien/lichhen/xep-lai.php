                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input value="<?=date("d-m-Y", strtotime($row['Time1']))?>" class="form-control"  placeholder="Số điện thoại" disabled=""   /> 
                            </div>
                            <div class="form-group text-centrer">
                             ...
                             <div class="form-group">
                                ...
                                <input value="<?=explode(' ', $row['Time2'])?>" type="number" min="0" max="23" class="form-control" name="gio" required="" placeholder="vd : 13,..."   />
                            </div>
