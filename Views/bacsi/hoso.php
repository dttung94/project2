 <div id="page-wrapper">
    ...
    ?>                      
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Tên</label>
                                <input value="<?=$row['DoctorName']?>" class="form-control" name="ten" placeholder="Tên" required=""  />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?=$row['Field']?>" class="form-control" name="linhvuc" placeholder="Lĩnh vực"   />
                            </div>
                            ...
                            <div class="form-group">
                               <label>Giới thiệu</label>
                                <textarea name="gioithieu" class="form-control" ><?=$row['Description']?></textarea> 
                            </div>
                              <div class="form-group">
                                <label>Ảnh</label>
                                <br>
                    ...
                    <div class="col-lg-4" style=""><a style="font-size: 17px;" href="?controller=bacsi&action=changepass"><u>Đổi mật khẩu</u></a></div>
                </div>
                <!-- /.row -->
            </div>
            <!-- /.container-fluid -->
