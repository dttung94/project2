            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                           ...
                           <li><a href="?controller=bacsi&action=hoso"><i class="fa fa-user fa-fw"></i> Hồ sơ</a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                             <a href="#"><i class="fas fa-user-cog fa-fw""></i></i> Lịch khám<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="?controller=bacsi&action=dang-dien-ra">Đang chờ khám</a>
                                </li>
                                  <li>
                                    <a href="?controller=bacsi&action=da-kham">Đã khám </a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="?controller=bacsi&action=list-benhnhan">Danh sách</a>
                                </li>
