 <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">Hồ sơ cá nhân
    ...
    ?>                      
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input value="<?=$row['Email']?>" class="form-control" name="email" placeholder="Số điện thoại"   />
                            </div>
                            <div class="form-group">
                                <label>Ngày sinh</label>
                                <input type="date" value="<?=$row['Birthday']?>" class="form-control" name="ngaysinh" placeholder="Ngày sinh" required=""  />
                            </div>
                            <div class="form-group">
                                <label>Số điện thoại</label>
                                <input type="text" value="<?=$row['Phone']?>" class="form-control" name="sdt" placeholder="Số điện thoại" required=""  />
                            </div>
                            <div class="form-group">
                               <label>Tiền sử bệnh án</label>
                                <textarea name="benhan" class="form-control" ><?=$row['Disease']?></textarea> 
                            </div>
                              <div class="form-group">
                                <label>Ảnh</label>
                                <br>
                                <img src="Upload/<?=$row['Image']?>" width="100%" style="margin: 20px 0px; max-width: 500px;max-height: 500px;">
                    ...
                    <div class="col-lg-4" style=""><a style="font-size: 17px;" href="?controller=benhnhan&action=changepass"><u>Đổi mật khẩu</u></a></div>
                </div>
                <!-- /.row -->
            </div>
            <!-- /.container-fluid -->
